...
List<Studentsnameacademics4> listusers=new Studentacademicssem4().listcondition(mentor_id,from, end);
for(Studentsnameacademics4 _user:listusers){
	...
	out.print("<td>"+new Studentacademicssem4().getsgpa(_user.getUsn()) +"</td>");
	out.print("</tr>");
	out.print("</tbody>");
	out.print("</table>");
...
out.print("<td>"+_user.getIa3marks1()+"</td>");
	...
	out.print("<tr>");
	out.print("<td>"+_user.getSubcode10()+"</td>");
	out.print("<td>"+_user.getSubname10()+"</td>");
	out.print("<td>"+_user.getIa1marks10()+"</td>");
	out.print("<td>"+_user.getIa2marks10()+"</td>");
	out.print("<td>"+_user.getIa3marks10()+"</td>");
	out.print("<td>"+_user.getTotalinternalmarks10()+"</td>");
	out.print("<td>"+_user.getExternalmarks10()+"</td>");
	out.print("<td>"+_user.getTotal10()+"</td>");
	out.print("<td>"+_user.getCredits10()+"</td>");
	out.print("</tr>");
...
%>
<center><a href="mentoracademic.jsp">Go back</a></center>   
