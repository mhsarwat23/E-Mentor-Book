...
List<Studentsnameacademics3> listusers=new Studentacademicssem3().listcondition(mentor_id,from, end);
for(Studentsnameacademics3 _user:listusers){
	...
	out.print("<td>"+new Studentacademicssem3().getsgpa(_user.getUsn()) +"</td>");
	out.print("</tr>");
	out.print("</tbody>");
	out.print("</table>");
