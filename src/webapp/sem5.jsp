...
th {
 ...
 <body>
    ...
    <form action="<%request.getContextPath();%>/Project/academicservlet2?page=submittingform5" method="post">
   ...
   <!--     <label for="ia3Marks">IA3 Marks:</label>-->
    ...
    <!--     <label for="totalInternalMarks">Total Internal Marks:</label>-->
     ...
     <!--   <label for="externalMarks">External Marks:</label>-->
        ...
        <td><input type="text" id="subName" name="subName6" placeholder="Enter subject name6" required></td>
       ...
       <td> <input type="number" id="ia1Marks" name="ia1Marks6" min="0" max="20" placeholder="Enter marks" required></td>
        ...
        <td><input type="text" id="subName" name="subName7" placeholder="Enter subject name7" required></td>
      ...
      <tr>  
        ...
        <td><input type="text" id="subName" name="subName8" placeholder="Enter subject name8" required></td>
       ...
       <input type="hidden" name="page" value="submittingform5">
