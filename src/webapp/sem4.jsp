...
th {
 ...
 <body>
    ...
    <form action="<%request.getContextPath();%>/Project/academicservlet2?page=submittingform4" method="post">
    ...
    <!--     <label for="totalInternalMarks">Total Internal Marks:</label>-->
     ...
     <!--   <label for="externalMarks">External Marks:</label>-->
       ...
       <td> <input type="number" id="ia1Marks" name="ia1Marks6" min="0" max="20" placeholder="Enter marks" required></td>
        ...
        <tr>
        <td><input type="text" id="subCode" name="subCode7" placeholder="Enter subject code7" required></td>
        
        <td><input type="text" id="subName" name="subName7" placeholder="Enter subject6 name" required></td>
        
        <td><input type="number" id="ia1Marks" name="ia1Marks7" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia2Marks" name="ia2Marks7" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia3Marks" name="ia3Marks7" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="totalInternalMarks" name="totalInternalMarks7" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="externalMarks" name="externalMarks7" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="credits" name="credits7" min="0" placeholder="Enter Credits" required></td>
      </tr> 
      <tr>  
        <td><input type="text" id="subCode" name="subCode8" placeholder="Enter subject code8" required></td>
        
        <td><input type="text" id="subName" name="subName8" placeholder="Enter subject8 name" required></td>
        
        <td><input type="number" id="ia1Marks" name="ia1Marks8" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia2Marks" name="ia2Marks8" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia3Marks" name="ia3Marks8" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="totalInternalMarks" name="totalInternalMarks8" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="externalMarks" name="externalMarks8" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="credits" name="credits8" min="0" placeholder="Enter Credits" required></td>
       </tr>
        <tr>
       <td><input type="text" id="subCode" name="subCode9" placeholder="Enter subject code9" required></td>
        
        <td><input type="text" id="subName" name="subName9" placeholder="Enter subject9 name" required></td>
        
        <td><input type="number" id="ia1Marks" name="ia1Marks9" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia2Marks" name="ia2Marks9" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia3Marks" name="ia3Marks9" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="totalInternalMarks" name="totalInternalMarks9" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="externalMarks" name="externalMarks9" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="credits" name="credits9" min="0" placeholder="Enter Credits" required></td>
       </tr>
        <tr>
       <td><input type="text" id="subCode" name="subCode10" placeholder="Enter subject code10" required></td>
        
        <td><input type="text" id="subName" name="subName10" placeholder="Enter subject10 name" required></td>
        
        <td><input type="number" id="ia1Marks" name="ia1Marks10" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia2Marks" name="ia2Marks10" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="ia3Marks" name="ia3Marks10" min="0" max="20" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="totalInternalMarks" name="totalInternalMarks10" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="externalMarks" name="externalMarks10" min="0" max="50" placeholder="Enter marks" required></td>
        
        <td><input type="number" id="credits" name="credits10" min="0" placeholder="Enter Credits" required></td>
       </tr>
       </table>
        <br><br>
        <%String usn=null;
       ...
       <input type="hidden" name="page" value="submittingform4">
