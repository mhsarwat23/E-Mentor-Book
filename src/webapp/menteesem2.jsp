...
List<Studentsnameacademics> listusers= new Studentacademicssem2().listcondition(mentor_id,from, end);
for(Studentsnameacademics _user:listusers){
	...
	out.print("<td>"+new Studentacademicssem2().getsgpa(_user.getUsn()) +"</td>");
