...
import oxf.database.model.Studentacademicssem2;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//	String usn=request.getParameter("usn");
			...
			//3rd subject
					...
					Studentsacademicsdetails stdacademicdetail=new Studentsacademicsdetails(usn,subcode1,subname1,ia1marks1,ia2marks1,ia3marks1,totalinternalmarks1,externalmarks1,credits1,subcode2,subname2,ia1marks2,ia2marks2,ia3marks2,totalinternalmarks2,externalmarks2,credits2,
					    ...
					    List<Studentsacademicsdetails> stsacademic=new Studentacademicssem1().listcheck();   
			    for(Studentsacademicsdetails sa:stsacademic) {
					if(sa.getUsn().equals(usn)) {
						new Studentacademicssem1().deletedetail(usn);
						
						new Studentacademicssem1().adddetails(stdacademicdetail);
						 BigDecimal sgpa=new Studentacademicssem1().getsgpa(usn);
		...
		case "submittingform2":{
			...
			String subcode1=request.getParameter("subCode1");
				...
				//3rd subject
						...
						int externalmarks9=Integer.parseInt(request.getParameter("externalMarks9"));
						int credits9=Integer.parseInt(request.getParameter("credits9"));
						Studentsacademicsdetails stdacademicdetail=new Studentsacademicsdetails(usn,subcode1,subname1,ia1marks1,ia2marks1,ia3marks1,totalinternalmarks1,externalmarks1,credits1,
								...
								subcode8,subname8,ia1marks8,ia2marks8,ia3marks8,totalinternalmarks8,externalmarks8,credits8,
								subcode9,subname9,ia1marks9,ia2marks9,ia3marks9,totalinternalmarks9,externalmarks9,credits9);
						    List<Studentsacademicsdetails> stsacademic=new Studentacademicssem2().listcheck();   
				
						       for(Studentsacademicsdetails sa:stsacademic) {
						if(sa.getUsn().equals(usn)) {
							new Studentacademicssem2().deletedetail(usn);
							new Studentacademicssem2().adddetails(stdacademicdetail);
							 BigDecimal sgpa=new Studentacademicssem1().getsgpa(usn);
							    request.setAttribute("sgpa", sgpa);
							    request.getRequestDispatcher("viewsgpa.jsp").forward(request, response);
			                 }
